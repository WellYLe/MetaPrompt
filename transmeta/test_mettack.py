...
def main():
    ...
    #     test(modified_adj)
    #     print(test(adj)-test(modified_adj))
    #     result.append(test(adj)-test(modified_adj))
    #     modified_adj=None # 清空modified_adj，避免后续攻击使用相同的修改图
    #     model=None # 清空model，避免后续攻击使用相同的模型
        
    # print("Accuracy drop:",result)
    # print("Mean accuracy drop:",np.mean(result))
    # print("Std accuracy drop:",np.std(result))
