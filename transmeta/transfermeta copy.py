...
from prompt_graph import GPF#, GPF_plus, GPPTPrompt, Gprompt
...
class Metattack(BaseMeta):
    ...
    def attack(self, ori_features, ori_adj, labels, idx_train, idx_unlabeled=None, n_perturbations=10, ll_constraint=True, ll_cutoff=0.004):
        ...
        encoder_path = os.path.join(current_dir, 'Experiment', 'pre_trained_model', {dataset_name}, '_EdgeFlip', 'EdgeFlipMAE.GCN.100hidden_dim.encoder.pth')
        classifier_path = os.path.join(current_dir, 'Experiment', 'pre_trained_model', {dataset_name}, '_EdgeFlip', 'EdgeFlipMAE.GCN.100hidden_dim.classifier.pth')
