...
def get_pretrain_task_delegate(args:argparse.Namespace):
    ...
    if args.pretrain_task == 'SimGRACE':
        ...
        pt = Edgepred_GPPT(dataset_name = args.dataset_name, gnn_type = args.gnn_type, hid_dim = args.hid_dim, gln = args.num_layer, num_epoch=args.epochs, device=args.device, num_workers=args.num_workers, datapath=args.data_path)
